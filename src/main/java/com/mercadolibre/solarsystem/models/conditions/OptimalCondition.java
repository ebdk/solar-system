...
public class OptimalCondition extends WeatherCondition {
  ...
  public boolean isOfCondition(SolarSystem solarSystem) {
    ...
    return arePlanetsNotAllinedWithCenter(center, firstPlanetPosition, secondPlanetPosition, thirdPlanetPosition);

  }

  private boolean arePlanetsNotAllinedWithCenter(Point2D center, Point2D firstPlanetPosition, Point2D secondPlanetPosition, Point2D thirdPlanetPosition) {
